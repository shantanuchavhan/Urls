    ...
    <div className='text-black flex flex-col gap-6 '>
      <div className=' md:flex   justify-between '>
        <div className='flex flex-col gap-2'>
          <div className='flex items-center justify-between bg-white p-2  rounded-large' style={{ borderRadius: "16px" }}>
          ...
          <div className='flex items-center justify-between bg-white px-2 rounded-large' style={{ borderRadius: "16px" }}>
